...
因此 R0-A/B1/B2/C1、已实现的 C2/C3 与 C4 candidate 只构成完整 App 的 process、协议、私有存储、内部 Workspace catalog、
pure Delivery 语义和 passive selection 地基，Runtime/Harness transport、垂直
