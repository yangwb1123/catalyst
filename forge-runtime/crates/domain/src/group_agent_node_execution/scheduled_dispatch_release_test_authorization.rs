...
pub(super) fn authorization(
    ...
    resign_authorization(&mut value);
    value
}

pub(super) fn resign_authorization(value: &mut GroupAgentScheduledNodeDispatchAuthorization) {
...
fn authorization_source(control: &GroupAgentScheduledNodeDispatchReleaseControl) -> Value {
    ...
    json!({
        ...
        "group_run_id": source.manifest.source.group_run_id,
        "group_id": source.manifest.source.group_id,
        "source_snapshot_sha256": source.source_snapshot_sha256,
        "graph_manifest_sha256": source.graph_manifest_sha256,
        "core_plan_sha256": source.core_plan_sha256,
        ...
        "schedule_sha256": control.schedule.schedule_sha256,
        "scheduled_contract_id": contract.contract_id,
        "scheduled_contract_sha256": contract.contract_sha256,
        ...
        "expected_last_event_sha256": source.last_event_sha256,
    })
}
...
fn authorization_execution(control: &GroupAgentScheduledNodeDispatchReleaseControl) -> Value {
    ...
    json!({
        ...
        "attempt": 1,
        "project_id": contract.node.project_id,
...
fn requirements() -> GroupAgentScheduledNodeDispatchReleaseRequirements {
...
fn merge(fields: &mut Map<String, Value>, value: Value) {
    let Value::Object(values) = value else {
        panic!("authorization fragment must be an object");
    };
