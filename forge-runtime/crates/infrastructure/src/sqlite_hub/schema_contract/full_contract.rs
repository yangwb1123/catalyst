...
const VERSION_TABLE_COUNTS: [usize; 16] =
    [0, 5, 8, 9, 11, 14, 16, 19, 20, 22, 23, 24, 28, 29, 30, 31];
const VERSION_EXPLICIT_INDEX_COUNTS: [usize; 16] =
    [0, 2, 3, 4, 6, 8, 10, 12, 14, 16, 18, 20, 24, 25, 27, 29];
