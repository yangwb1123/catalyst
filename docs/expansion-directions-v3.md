...
当前系统能工作的原因是**所有 harne 闸门在末尾统一跑**——这对 3 相位、5-10 分钟的单次 run
...
v3 ROADMAP 的「Web-UI」点到此方向但不具体。本方向把 web-ui 定位为**结果是展示层**,
...
1. **MV P 停滞**:一个 20 项 ROADMAP 到第 18 项时,团队想发版,但系统阻止——必须做完最后 2 项。
