...
func TestReviewFindingsLedger_OneDirectionImplementerReceivesReviewerDoesNot(t *testing.T) {
	...
	implPrompt := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "implementer", Agent: "implementer"}, "balanced", nil, nil, f)
	...
	revPrompt := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", nil, nil, f)
