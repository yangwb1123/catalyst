...
func TestBudgetTier_DownTierLogsHonestly(t *testing.T) {
	...
	var logs []string
	tierOf := phaseTierResolver("balanced", func() float64 { return 0.85 }, nil, func(s string) { logs = append(logs, s) }, "", nil, nil, nil)
	...
	var quiet []string
	inBudget := phaseTierResolver("balanced", func() float64 { return 0.50 }, nil, func(s string) { quiet = append(quiet, s) }, "", nil, nil, nil)
	...
	var floorLog []string
	floor := phaseTierResolver("balanced", func() float64 { return 0.95 }, nil, func(s string) { floorLog = append(floorLog, s) }, "", nil, nil, nil)
...
func TestBudgetTier_PhaseTierByNameMatchesResolver(t *testing.T) {
	phase := asset.Phase{Name: "implementer", Agent: "implementer", ModelTier: "opus"}
	wf := asset.Workflow{Phases: []asset.Phase{phase}}
	tierOf := phaseTierResolver("balanced", func() float64 { return 0.85 }, nil, nil, "", nil, nil, nil)
