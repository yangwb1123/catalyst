...
func TestBuildPrompt_EmbedsRolePhaseTier(t *testing.T) {
	...
	got := buildPrompt("/home/u1/catalyst", p, "balanced", unbudgetedTier("balanced"), nil, nil, nil)
...
func TestBuildPrompt_StillInjectsHardConstraints(t *testing.T) {
	got := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", unbudgetedTier("balanced"), nil, nil, nil)
...
func TestBuildPrompt_IncludesMemoryEntries(t *testing.T) {
	...
	got := buildPrompt(root, asset.Phase{Name: "build", Agent: "implementer"}, "balanced", unbudgetedTier("balanced"), nil, nil, nil)
...
func TestBuildPrompt_InjectsGateLedger(t *testing.T) {
	...
	got := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", unbudgetedTier("balanced"), l, nil, nil)
...
func TestBuildPrompt_NilOrEmptyLedgerOmitsBlock(t *testing.T) {
	p := asset.Phase{Name: "reviewer", Agent: "reviewer"}
	nilGot := buildPrompt("/home/u1/catalyst", p, "balanced", unbudgetedTier("balanced"), nil, nil, nil)
	emptyGot := buildPrompt("/home/u1/catalyst", p, "balanced", unbudgetedTier("balanced"), newGateLedger(), nil, nil)
...
func TestBuildPrompt_InjectsPhaseOutput(t *testing.T) {
	...
	got := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", unbudgetedTier("balanced"), nil, po, nil)
...
func TestBuildPrompt_NilOrEmptyPhaseOutputOmitsBlock(t *testing.T) {
	...
	nilGot := buildPrompt("/home/u1/catalyst", p, "balanced", unbudgetedTier("balanced"), nil, nil, nil)
	emptyGot := buildPrompt("/home/u1/catalyst", p, "balanced", unbudgetedTier("balanced"), nil, newPhaseOutputLedger(), nil)
	for _, got := range []string{nilGot, emptyGot} {
...
func TestAgentExecutor_ObserveRecordsFeedsForwardOutput(t *testing.T) {
	...
	ex := agentExecutor(runOpts{executor: "command", agentCmd: "echo", root: t.TempDir()}, func(string) {}, nil, unbudgetedTier(""), nil, nil, po, feeds, nil, nil, nil)
...
func TestAgentExecutor_PermissionModeOnlyForClaude(t *testing.T) {
	mk := func(cmd string) string {
		ex := agentExecutor(runOpts{executor: "command", agentCmd: cmd, agentPermission: "acceptEdits", root: t.TempDir()}, func(string) {}, nil, unbudgetedTier(""), nil, nil, nil, nil, nil, nil, nil)
		ce, ok := ex.(orchestrator.CommandExecutor)
		if !ok {
			t.Fatalf("executor=command must yield a CommandExecutor, got %T", ex)
		}
...
func TestAgentExecutor_EmptyPermissionDisablesFlag(t *testing.T) {
	ex := agentExecutor(runOpts{executor: "command", agentCmd: "claude", agentPermission: "", root: t.TempDir()}, func(string) {}, nil, unbudgetedTier(""), nil, nil, nil, nil, nil, nil, nil)
	ce := ex.(orchestrator.CommandExecutor)
...
func TestAgentExecutor_ModelTierForClaude(t *testing.T) {
	mk := func(cmd, agent string) string {
		ex := agentExecutor(runOpts{executor: "command", agentCmd: cmd, root: t.TempDir()}, func(string) {}, nil, unbudgetedTier(""), nil, nil, nil, nil, nil, nil, nil)
		ce := ex.(orchestrator.CommandExecutor)
...
func TestAgentExecutor_MaxBudgetForClaude(t *testing.T) {
	mk := func(cmd, budget string) string {
		ex := agentExecutor(runOpts{executor: "command", agentCmd: cmd, agentMaxBudgetUSD: budget, root: t.TempDir()}, func(string) {}, nil, unbudgetedTier(""), nil, nil, nil, nil, nil, nil, nil)
		ce := ex.(orchestrator.CommandExecutor)
