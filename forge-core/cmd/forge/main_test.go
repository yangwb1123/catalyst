...
func TestBuildPrompt_EmbedsRolePhaseTier(t *testing.T) {
	...
	got := buildPrompt("/home/u1/catalyst", p, "balanced", nil, nil, nil)
...
func TestBuildPrompt_StillInjectsHardConstraints(t *testing.T) {
	got := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", nil, nil, nil)
...
func TestBuildPrompt_IncludesMemoryEntries(t *testing.T) {
	...
	got := buildPrompt(root, asset.Phase{Name: "build", Agent: "implementer"}, "balanced", nil, nil, nil)
...
func TestBuildPrompt_InjectsGateLedger(t *testing.T) {
	...
	got := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", l, nil, nil)
...
func TestBuildPrompt_NilOrEmptyLedgerOmitsBlock(t *testing.T) {
	p := asset.Phase{Name: "reviewer", Agent: "reviewer"}
	nilGot := buildPrompt("/home/u1/catalyst", p, "balanced", nil, nil, nil)
	emptyGot := buildPrompt("/home/u1/catalyst", p, "balanced", newGateLedger(), nil, nil)
...
func TestBuildPrompt_InjectsPhaseOutput(t *testing.T) {
	...
	got := buildPrompt("/home/u1/catalyst", asset.Phase{Name: "reviewer", Agent: "reviewer"}, "balanced", nil, po, nil)
...
func TestBuildPrompt_NilOrEmptyPhaseOutputOmitsBlock(t *testing.T) {
	...
	nilGot := buildPrompt("/home/u1/catalyst", p, "balanced", nil, nil, nil)
	emptyGot := buildPrompt("/home/u1/catalyst", p, "balanced", nil, newPhaseOutputLedger(), nil)
	for _, got := range []string{nilGot, emptyGot} {
