...
// ReadyAuthorization is passive policy for at most one future release of the
// exact selected ready node. Every current effect fact remains false.
type ReadyAuthorization struct {
	V                                    uint16                         `json:"v"`
	...
	ProgressSnapshotSHA256               string                         `json:"progress_snapshot_sha256"`
	ReconcileDecisionSHA256              string                         `json:"reconcile_decision_sha256"`
	...
	MaximumFutureNodeReleases            uint16                         `json:"maximum_future_node_releases"`
