#!/usr/bin/env python3
"""Closed-package integrity tests for knowledge-graph-curation."""
...
def _load_checker() -> object:
    ...
    specification = importlib.util.spec_from_file_location(
        "_knowledge_graph_curation_package_integrity_test", path)
...
class ClosedPackageTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.root = self.base / "knowledge-graph-curation"
    ...
    def seal(self) -> None:
        ...
        value = {"api_version": check_package.API_VERSION, "files": files,
                 ...
                 "package_name": "knowledge-graph-curation"}
    ...
    def test_noncanonical_unknown_and_deep_manifest_reject(self) -> None:
        ...
        self.assertEqual(result.stderr, b"knowledge-graph-curation package rejected: "
    ...
    def test_deleted_cwd_relative_rejects_and_no_arg_is_anchored(self) -> None:
        ...
        self.assertEqual((anchored.returncode, anchored.stdout),
                         (0, b"knowledge-graph-curation portable package VALID\n"))
