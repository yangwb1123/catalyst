#!/usr/bin/env python3
"""Closed-package integrity tests for change-impact-cost-risk."""
...
def _load_checker() -> object:
    ...
    specification = importlib.util.spec_from_file_location(
        "_change_impact_cost_risk_package_integrity_test", path)
...
class ClosedPackageTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.root = self.base / "change-impact-cost-risk"
    ...
    def seal(self) -> None:
        ...
        value = {"api_version": check_package.API_VERSION, "files": files,
                 ...
                 "package_name": "change-impact-cost-risk"}
    ...
    def test_noncanonical_unknown_and_deep_manifest_reject(self) -> None:
        ...
        self.assertEqual(result.stderr, b"change-impact-cost-risk package rejected: "
    ...
    def test_deleted_cwd_relative_rejects_and_no_arg_is_anchored(self) -> None:
        ...
        self.assertEqual((anchored.returncode, anchored.stdout),
                         (0, b"change-impact-cost-risk portable package VALID\n"))
