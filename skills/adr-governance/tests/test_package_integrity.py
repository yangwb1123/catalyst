#!/usr/bin/env python3
"""Closed-package integrity tests for adr-governance."""
...
def _load_checker() -> object:
    ...
    specification = importlib.util.spec_from_file_location(
        "_adr_governance_package_integrity_test", path)
...
class ClosedPackageTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.root = self.base / "adr-governance"
    ...
    def test_noncanonical_unknown_and_deep_manifest_reject(self) -> None:
        ...
        self.assertEqual(result.stderr, b"adr-governance package rejected: "
    ...
    def test_deleted_cwd_relative_rejects_and_no_arg_is_anchored(self) -> None:
        ...
        self.assertEqual((anchored.returncode, anchored.stdout),
                         (0, b"adr-governance portable package VALID\n"))
