...
ROUTE_INCLUDE_FLOORS = {
    ...
    "user-experience": {".agent/skills/code-review.md": "instruction", ".agent/skills/information-interaction-design.md": "instruction", ".agent/skills/design-system-accessibility.md": "instruction", ".agent/skills/frontend-client-engineering.md": "instruction", ".agent/engineering/frontend-design-gates.yml": "instruction", ".agent/engineering/frontend-profiles.yml": "trusted_context", ".agent/eval/frontend-design-package.schema.yml": "trusted_context", "docs/design/ai-engineering-os/frontend-design-standard.md": "trusted_context"},
