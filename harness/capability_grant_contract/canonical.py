"""Strict bounded canonical JSON codec shared by the reference evaluator."""
...
class ContractError(ValueError):
    """The caller-supplied contract is invalid."""
...
def _forbidden_scalar(character: str) -> bool:
    ...
    return (code <= 0x1F or code == 0x7F or 0xD800 <= code <= 0xDFFF or
            code in {0x061C, 0x200E, 0x200F,
            0x2028, 0x2029} or 0x202A <= code <= 0x202E or 0x2066 <= code <= 0x2069)


def _validate_node(value: Any, depth: int = 1) -> None:
    if depth > MAX_DEPTH:
