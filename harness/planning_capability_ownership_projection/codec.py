"""Bounded exact compact canonical JSON for ADR-0069."""
...
from .constants import MAX_DEPTH, MAX_FIELDS, MAX_I64, MAX_ITEMS, MAX_JSON_STRING_BYTES, MIN_I64
...
def walk(value: object, depth: int = 1) -> None:
    if depth > MAX_DEPTH:
    ...
    if isinstance(value, str):
        if len(value.encode("utf-8")) > MAX_JSON_STRING_BYTES:
            raise ContractError("string exceeds UTF-8 byte limit")
