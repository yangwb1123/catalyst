"""Strict bounded canonical JSON codec for command observation adaptation."""
...
def canonical_command(command: object) -> bytes:
    """Canonicalize an exact command object."""
    return canonical_json(command)


def canonical_observation(observation: object) -> bytes:
    """Canonicalize an exact command observation object."""
